...
/**
 * Unit tests for UserProfile module
 */
public class UserProfileTest {
    ...
    public void setUp() {
        ...
        testProfile.setLocation("San Francisco");
    }
    ...
    public void testUserProfileCreation() {
        ...
        assertEquals("user123", testProfile.getUserId());
        ...
        assertNotNull(testProfile.getCreatedAt());
    }

    @Test
    public void testUserProfileFullName() {
        String fullName = testProfile.getFullName();
        assertEquals("John Doe", fullName);
    }

    @Test
    public void testUserProfileDefaultActive() {
        assertTrue(testProfile.isActive());
    }
    ...
    // Exception Tests
    @Test
    public void testCreateProfileWithNullUserIdThrowsException() {
        UserProfile invalidProfile = new UserProfile();
        invalidProfile.setFirstName("John");
        invalidProfile.setLastName("Doe");
        invalidProfile.setEmail("john@example.com");
    ...
    @Test
    public void testUpdateNonExistentProfileThrowsException() {
        testProfile.setId("nonexistent");
        assertThrows(UserProfileException.class, () -> service.updateProfile(testProfile));
    }

    @Test
    public void testDeleteNonExistentProfileThrowsException() {
        assertThrows(UserProfileException.class, () -> service.deleteProfile("nonexistent"));
    }
